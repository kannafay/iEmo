...
function init_emwi() {
	$style = 'emwi-css';
	$css_file = fileUri().'/plugins/external-media-without-import/external-media-without-import.css';
	wp_register_style( $style, $css_file );
	wp_enqueue_style( $style );
	$script = 'emwi-js';
	$js_file = fileUri().'/plugins/external-media-without-import/external-media-without-import.js';
